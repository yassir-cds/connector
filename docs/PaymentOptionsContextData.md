...
------------ | ------------- | ------------- | -------------
**currency** | [**inline**](#CurrencyEnum) | The currency of the order (ISO 4217) | 
**country** | [**inline**](#CountryEnum) | The code of the country (ISO 3166-1 alpha-2) | 
**amount** | **kotlin.Long** | The amount | 
