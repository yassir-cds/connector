 ...
 * @param paymentRequestId The payment session identifier (guid), use it for 3DS payment
 ...
 */
data class Card3DsValidateAuthenticationAndAuthorizeRequest (
