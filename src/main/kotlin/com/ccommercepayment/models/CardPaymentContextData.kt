 ...
 * @param paymentAttempt The payment attempt number
 */
data class CardPaymentContextData (
    ...
    @Json(name = "currency")
    val currency: CardPaymentContextData.Currency,
    /* The code of the country (ISO 3166-1 alpha-2) */
    @Json(name = "country")
    val country: CardPaymentContextData.Country,
    /* The payment option reference */
    @Json(name = "paymentOptionRef")
    val paymentOptionRef: kotlin.String,
    /* The customer reference */
    @Json(name = "customerRef")
    val customerRef: kotlin.String,
    /* The payment attempt number */
    @Json(name = "paymentAttempt")
    val paymentAttempt: kotlin.Int? = null
) {
