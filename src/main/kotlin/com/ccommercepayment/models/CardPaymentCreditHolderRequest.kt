...
/**
 * request object for CardPaymentCreditHolder
 ...
 * @param creditRef The order reference linked to the schedule and transaction
 * @param creditTag The order tag is a label for the schedule
 * @param amount The amount of the payment
 * @param expirationDate The card's expiration date
 * @param cardNumber The card number
 * @param cardScheme The card type
 */
data class CardPaymentCreditHolderRequest (
    ...
    val cardScheme: CardPaymentCreditHolderRequest.CardScheme? = null
) {
